                  ...
                  <div className="flex justify-between items-center pl-4">
                    <div className="flex">
                      <Image
                        ...
                        width={0}
                      />
                      <h5 className="text-3xl ml-2">Logout</h5>
                    </div>
                  ...
                  <div className="flex justify-between items-center pl-4">
                    <div className="flex">
                      <Image
                        ...
                        width={0}
                      />
                      <h5 className="text-3xl ml-2">Medications</h5>
                    </div>
                    <ModalNextButton
                      link="medications"
                  ...
                  <div className="flex justify-between items-center pl-4">
                    <div className="flex">
                      <Image
                        ...
                        width={0}
                      />
                      <h5 className="text-3xl ml-2">Change Pin</h5>
                    </div>
                  ...
                  <div className="flex justify-between items-center pl-4">
                    <div className="flex">
                      <Image
                        ...
                        width={0}
                      />
                      <h5 className="text-3xl ml-2">Delete Account</h5>
                    </div>
                    <ModalNextButton
                      link="settings"

    ...
    <div className="relative w-fit h-full flex items-center flex-1">
      ...
      <div className="absolute left-0 w-full h-full flex flex-row gap-4 items-center">
        <div className="h-full w-auto aspect-square relative">
          ...
          <div className="absolute w-full h-full z-auto font-quantico text-center font-bold text-2xl flex justify-center items-center text-white text-stroke-4 text-stroke-[#482D0D] text-shadow-[#603A0C] paint-stroke">
            {level}
          </div>
        </div>

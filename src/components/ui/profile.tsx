...
const Profile: React.FC<ProfileProps> = ({character = 'duck'}) => {
  ...
  return (
    ...
    <div className="relative w-[145px] h-[154px]">
      
      {/* Background */}
      <div className="absolute inset-1 rounded-[44.268px] bg-[#D2D8BF]" />
      ...
      >
        ...
        />
        <defs>
          <linearGradient id="paint0_linear_13912_540" x1="59.0244" y1="60.5" x2="71.5671" y2="-19.9207" gradientUnits="userSpaceOnUse">
            <stop stopColor="#38401E"/>
            <stop offset="1" stop-color="#3A4222"/>
          </linearGradient>
        </defs>
      </svg>
      ...
      <svg 
        ...
        viewBox='0 0 8 9'
      >
        <ellipse cx="4.28753" cy="4.12375" rx="2.95122" ry="4.42683" transform="rotate(35.0528 4.28753 4.12375)" fill="#F3FFDB"/>
      </svg>
    </div>
  );
}
